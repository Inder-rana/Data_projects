...
Created data visualization based on: Revenue, Sales Qty, Revenue by Markets, Sales Qty by Markets, Month, Year, Revenue trend by Month-Year, Top 5 Customers, and Top 5 Products. To check the dashboard in more detail, open `Power_BI_dashboard.pbix` and `Tableau_dashboard.twbx` files in their relevant environment. 
